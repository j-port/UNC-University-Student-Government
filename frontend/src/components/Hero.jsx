    ...
    const stats =
        content.heroStats?.length > 0
            ? content.heroStats.map((stat) => {
                  ...
                  if (
                      stat.section_key === "programs-events" &&
                      !automatedStats.loading
                  ) {
                      return {
                    ...
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <span className="text-sm font-medium">
                                Academic Year 2024-2025 • Now Active
                            </span>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            The University Student Government of UNC is
                            committed to amplifying student voices, ensuring
                            transparency, and building a thriving campus
                            community for all Navegantes.
                        </motion.p>
                            ...
                            <Link to="/feedback" className="w-full sm:w-auto">
                                <motion.button
                                    whileHover={{
                                        scale: 1.05,
                                        boxShadow:
                                            "0 20px 40px rgba(225, 29, 72, 0.4)",
                                    }}
                                    whileTap={{ scale: 0.95 }}
                        ...
                        <motion.div
                            ...
                            {stats.length > 0 ? (
                                ...
                                <div className="col-span-2 md:col-span-4 bg-white/10 backdrop-blur-md rounded-xl p-4 border border-white/10 text-center">
                                    <p className="text-white/60 text-sm">
                                        Stats not available - Add content in
                                        Admin Panel
                                    </p>
                                </div>
                            )}
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div
                            ...
                            <p className="text-lg text-white/80 mb-8 leading-relaxed">
                                TINIG DINIG is the official feedback mechanism
                                of the USG where every Navegante can share their
                                concerns, suggestions, and ideas. We believe
                                that every voice matters, and together, we can
                                create meaningful change in our university.
                            </p>
                            ...
                            <div className="relative">
                                ...
                                <motion.div
                                    ...
                                    <div className="flex items-center space-x-4 mb-6">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-school-grey-800">
                                                Quick Feedback Form
                                            </h3>
                                    ...
                                    <div className="space-y-4">
                                        <div className="bg-school-grey-50 rounded-xl p-4">
                                            <label className="text-sm font-medium text-school-grey-600 block mb-2">
                                                Category
                                            </label>
                                            <div className="flex flex-wrap gap-2">
                                                {[
                                                    ...
                                                    <span
                                                        key={cat}
                                                        className="px-3 py-1 bg-white rounded-full text-sm text-school-grey-600 border">
                                                        {cat}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <div className="bg-school-grey-50 rounded-xl p-4">
                                            ...
                                            <div className="h-20 bg-white rounded-lg border-2 border-dashed border-school-grey-200 flex items-center justify-center">
                                                <span className="text-school-grey-400">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <label className="flex items-center space-x-2 text-sm text-school-grey-600">
                                                <input
                                                    type="checkbox"
                                                    className="rounded text-university-red"
                                                />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div
                        ...
                        <p className="text-lg text-school-grey-600 max-w-2xl mx-auto">
                            Your student government provides various services to
                            ensure transparency and keep you informed about
                            university affairs.
                        </p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {features.length > 0 ? (
                            ...
                            <div className="col-span-3 bg-school-grey-50 rounded-2xl p-8 text-center">
                                <p className="text-school-grey-600">
                                    Quick access cards not available - Add
                                    content in Admin Panel
                                </p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12">
                        ...
                        <motion.div
                            ...
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <Link
                                    to="/bulletins"
                                    className="text-university-red font-medium hover:underline">
                                    View All →
                                </Link>
                            </div>
                                            ...
                                            <motion.div
                                                ...
                                                <div className="flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        <h3 className="font-semibold text-school-grey-800 mt-2">
                                                            {announcement.title}
                                                        </h3>
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, x: 0 }}
                            viewport={{ once: true }}>
                            <h2 className="text-2xl font-bold text-school-grey-800 mb-8">
                                Quick Access
                            </h2>
                                ...
                                {[
                                    ...
                                    <Link key={index} to={item.path}>
                                        <motion.div
                                            ...
                                            <div
                                                className={`w-14 h-14 ${item.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <motion.div
                        ...
                        <p className="text-lg text-white/70 mb-8">
                            We're here to listen. Your feedback helps us serve
                            you better.
                        </p>
                        <Link to="/feedback">
                            <motion.button
