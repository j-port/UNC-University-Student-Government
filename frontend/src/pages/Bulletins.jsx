...
import { announcementsAPI, issuancesAPI } from "../lib/api";
import {
    FileText,
    Megaphone,
    ArrowRight,
...
export default function Bulletins() {
    ...
    useEffect(() => {
        const loadData = async () => {
            ...
            try {
                const [announcementsResult, issuancesResult] =
                    await Promise.all([
                        announcementsAPI.getAll({ status: "published" }),
                        issuancesAPI.getAll(),
                    ]);
                                ...
                                (announcements.length === 0 ? (
                                    <motion.div
                                        ...
                                        <p className="text-school-grey-500">
                                            Announcements are currently not
                            ...
                            {activeTab === "issuances" &&
                                (issuances.length === 0 ? (
                                    <motion.div
                                        ...
                                        <p className="text-school-grey-500">
                                            Official documents and issuances are
                                            currently not available. Check back
                                            soon!
                                        </p>
                                    </motion.div>
                                ) : (
